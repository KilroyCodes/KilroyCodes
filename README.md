...
|---            |---          |---        |---         |
|[8-Week SQL Challenge](https://github.com/KilroyCodes/8-Week-SQL-Challenge)|Data with Danny has created a series of SQL challenges covering several skillsets|• Joins (left, lateral)<br>• Case/When<br>• Date_trunc<br>• Cast<br>• Row_number<br>• Temp tables|★★★☆☆<br>*Pizza runner got surprisingly complex towards the end!*|
